/************************ dSPACE target specific file *************************
   ...
   Include file .\Bilateral_Ankle_Exo_rti1202\Bilateral_Ankle_Exo_th.c :

   Task Configuration file for model : Bilateral_Ankle_Exo

   RTI1202 7.9 (02-Nov-2017)/2.17
   15-Jun-2020 21:41:52
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\Bilateral_Ankle_Exo_rti1202\Bilateral_Ankle_Exo_th.c is for ST).
# endif
